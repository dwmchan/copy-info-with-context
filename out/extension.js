 ...
 */
function registerCycleCsvOutputModeCommand(context) {
    const command = vscode.commands.registerCommand('copyInfoWithContext.cycleCsvOutputMode', async () => {
        const config = vscode.workspace.getConfiguration('copyInfoWithContext');
        ...
        vscode.window.showInformationMessage(`CSV Output Mode: ${nextMode.toUpperCase()} ${icons[nextMode]}`);
    });
