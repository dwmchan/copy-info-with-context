 ...
 */
function isBirthDateField(text, matchIndex) {
...
exports.isBirthDateField = isBirthDateField;
/**
 ...
 */
function isPlausibleBirthDate(dateStr) {
    try {
...
exports.isPlausibleBirthDate = isPlausibleBirthDate;
/**
 ...
 */
function shouldMaskAsDateOfBirth(text, matchIndex, dateValue) {
...
exports.shouldMaskAsDateOfBirth = shouldMaskAsDateOfBirth;
/**
 ...
 */
function validateAustralianTFN(tfn) {
    // Extract digits only
 ...
 */
function validateAustralianABN(abn) {
    // Extract digits only
...
exports.validateAustralianABN = validateAustralianABN;
/**
 ...
 */
function isValidBSBFormat(bsb) {
    // Extract digits only
    const digits = bsb.replace(/\D/g, '');
    // BSB must be exactly 6 digits
    return digits.length === 6;
}
exports.isValidBSBFormat = isValidBSBFormat;
/**
...
exports.isValidIBANFormat = isValidIBANFormat;
/**
