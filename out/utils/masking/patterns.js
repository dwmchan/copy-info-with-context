...
exports.DETECTION_PATTERNS = exports.patternFactory = void 0;
/**
...
class PatternFactory {
     ...
     */
    getEnabledPatterns(enabledTypes) {
 ...
 */
exports.patternFactory = new PatternFactory();
/**
 ...
 */
exports.DETECTION_PATTERNS = new Proxy({}, {
    get: (target, prop) => {
        return exports.patternFactory.getPattern(prop);
    },
    has: (target, prop) => {
        return exports.patternFactory.hasPattern(prop);
    },
    ownKeys: () => {
        return exports.patternFactory.getAllTypes();
    }
});
