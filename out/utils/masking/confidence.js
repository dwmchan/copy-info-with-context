...
exports.isInsideFieldName = exports.isNonBirthDateField = exports.calculateMaskingConfidence = exports.getAdaptiveThreshold = exports.detectStructureType = exports.checkStatisticalAnomalies = void 0;
/**
 * Domain-specific prior probabilities for PII patterns
 * Based on empirical false positive rates
 */
const PATTERN_PRIOR_PROBABILITIES = {
 ...
 */
function checkStatisticalAnomalies(value, patternType) {
...
exports.checkStatisticalAnomalies = checkStatisticalAnomalies;
/**
 ...
 */
function detectStructureType(contextBefore, contextAfter) {
...
exports.detectStructureType = detectStructureType;
/**
 ...
 */
function getAdaptiveThreshold(baseThreshold, structureType, patternType, maskingMode) {
 ...
 */
function calculateMaskingConfidence(text, matchIndex, matchValue, patternType) {
...
exports.calculateMaskingConfidence = calculateMaskingConfidence;
/**
 ...
 */
function isNonBirthDateField(text, matchIndex) {
...
exports.isNonBirthDateField = isNonBirthDateField;
/**
 ...
 */
function isInsideFieldName(text, matchIndex, matchLength) {
...
exports.isInsideFieldName = isInsideFieldName;
