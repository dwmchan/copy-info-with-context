...
exports.FORMAT_VALIDATORS = exports.ibanCheck = exports.validateEmail = exports.validateBirthDate = exports.abnCheck = exports.tfnCheck = exports.luhnCheck = void 0;
/**
...
function validateEmail(s) {
    if (!s || typeof s !== 'string') {
        return { isValid: false, confidence: 0.0, reason: 'Empty or invalid' };
    }
    const email = s.trim().toLowerCase();
    // basic format check
    const re = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    if (!re.test(email)) {
        return { isValid: false, confidence: 0.0, reason: 'Malformed email' };
    }
