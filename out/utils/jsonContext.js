...
exports.getJsonPath = exports.findJsonPathByPosition = void 0;
...
function findJsonPathByPosition(jsonText, position) {
    try {
        const targetPosition = (0, positionHelpers_1.getAbsoluteCharPosition)(jsonText, position.line, position.character);
        const contextStack = [];
        let inString = false;
...
exports.findJsonPathByPosition = findJsonPathByPosition;
